...
Примечание: ⚠️ – означает, что для данных дистрибутивов, теоретически, все присутствующие роли в проекте могут быть успешно установлены, однако для этого необходимо иметь более низкую версию всех сопутствующих пакетов `Ansible`, а также, возможно, более низкую версию Python на исполняемой системе. Это связано с тем, что актуальный (последние версии) `Ansible` не может работать с той версией Python, которая установлена на целевых дистрибутивах по умолчанию.
